...
class PredictRasterAlgorithm(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        features_all = ['left', 'top', 'right', 'bottom', 'row_index', 'col_index', 'Parksdist', 'RESULT','OUTPUT', 'DISTANCE']
        ...
        columns_all = ['left', 'top', 'right', 'bottom', 'row_index', 'col_index', 'PARKSDISTAN', 'fountainsvi', 'roadnoiseco', 'DISTANCE']
        ...
        grid_points_data_x = grid_points_data[['lat', 'lon']].values.tolist()
        ...
        grid_points_predictions = model_rk.predict(p=grid_points_data_input, x = np.array(grid_points_data_x))
    ...
    def name(self):
        return 'predict_raster05 parks and lden'

    def displayName(self):
        return 'Predict Raster05 parks and lden'
