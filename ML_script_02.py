...
features_dataset = ['latitude', 'longitude', 'ISOPleasan', 'PARKSDISTAN', 'fountainsvi', 'roadnoiseco', 'treesvisibi', 'vi20mbigger', 'DISTANCE', 'SVF', 'VISIBLE']
...
places_with_5_or_more_points = grouped_stats[grouped_stats['row_count'] >= 5]
...
model_filename = 'C:/Users/n.smit/OneDrive - Oosterhoff Group/Documents/Master Thesis/Coding/predictions_QGIS/model_rf_regressor.joblib'

# Save the model to the specified file path
# dump(rf_regressor, model_filename)


# rf_regressor.save_model('C:/Users/n.smit/OneDrive - Oosterhoff Group/Documents/Master Thesis/Coding/predictions_QGIS/model_rf_regressor.txt')
